...
export default function AutomatePage() {
  ...
  return (
    <>
      {/* SEO Structured Data */}
      <ServiceSchema service="automate" />
      <BreadcrumbSchema 
        items={[
          { name: "Home", url: "https://sidekicksystems.com" },
          { name: "Automate", url: "https://sidekicksystems.com/automate" }
        ]}
      />
      ...
      <div className="pb-24">
        ...
        <section className="px-6 md:px-12 py-16 max-w-7xl mx-auto">
          <motion.div
            ...
            className="text-center mb-12"
          >
            <h2 className="dm text-3xl md:text-4xl font-bold mb-4">Amplify Your Automation</h2>
            <p className="text-lg text-white/70 max-w-2xl mx-auto">
              Automation works best with the right foundation. Here's what pairs perfectly with it.
            </p>
          </motion.div>
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-white/60">Custom websites that convert</p>
                </div>
                <div className="text-3xl">🚀</div>
              </div>
              <p className="text-white/70 mb-4 text-sm leading-relaxed">
                Need a website to automate? We build high-converting sites with built-in automation hooks—forms that connect to your CRM, lead capture that triggers workflows, and analytics that feed your dashboards.
              </p>
              <Link
                href="/launch"
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div>
                  ...
                  <p className="text-sm text-white/60">Make smarter, data-driven decisions</p>
                </div>
                <div className="text-3xl">💡</div>
              </div>
              <p className="text-white/70 mb-4 text-sm leading-relaxed">
                Pair automation with AI for next-level efficiency. Add smart chatbots to qualify leads before they hit your workflow, or dashboards that show exactly which automations are saving you the most time.
              </p>
              <Link
                href="/intelligence"
                className="inline-flex items-center gap-2 text-sm font-medium text-white/80 hover:text-white transition-colors"
